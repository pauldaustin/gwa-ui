...
@WebServlet(urlPatterns = "/rest/basicAuth", loadOnStartup = 1)
public class DeveloperBasicAuthServlet extends BaseServlet {
  ...
  protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
    throws ServletException, IOException {
    this.apiService.developerBasicAuthGet(request, response);
  }
