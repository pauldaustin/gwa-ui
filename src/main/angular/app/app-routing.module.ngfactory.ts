...
import * as import9 from './EndPoint/EndPointListMyComponent.ngfactory';
import * as import10 from './EndPoint/EndPointListComponent.ngfactory';
import * as import11 from './EndPoint/EndPointDetailComponent.ngfactory';
import * as import12 from '@angular/common/src/location/platform_location';
...
import * as import15 from './EndPoint/EndPointListMyComponent';
import * as import16 from './EndPoint/EndPointListComponent';
import * as import17 from './EndPoint/EndPointDetailComponent';
import * as import18 from '@angular/core/src/application_ref';
import * as import19 from '@angular/router/src/url_handling_strategy';
import * as import20 from '@angular/router/src/route_reuse_strategy';
import * as import21 from '@angular/router/src/router';
import * as import22 from '@angular/core/src/linker/ng_module_factory_loader';
...
class AppRoutingModuleInjector extends import0.NgModuleInjector<import1.AppRoutingModule> {
  ...
  constructor(parent:import8.Injector) {
    super(parent,[
      import9.EndPointListMyComponentNgFactory,
      import10.EndPointListComponentNgFactory,
      import11.EndPointDetailComponentNgFactory
    ]
    ,([] as any[]));
  }
  ...
  get _LocationStrategy_4():any {
    if ((this.__LocationStrategy_4 == null)) { (this.__LocationStrategy_4 = import2.provideLocationStrategy(this.parent.get(import12.PlatformLocation),this.parent.get(import13.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_3)); }
  ...
  get _NgModuleFactoryLoader_8():import6.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_8 == null)) { (this.__NgModuleFactoryLoader_8 = new import6.SystemJsNgModuleLoader(this.parent.get(import14.Compiler),this.parent.get(import6.SystemJsNgModuleLoaderConfig,(null as any)))); }
  ...
  get _ROUTES_9():any[] {
      if ((this.__ROUTES_9 == null)) { (this.__ROUTES_9 = [[
        ...
        {
          path: 'endPoints/my',
          component: import15.EndPointListMyComponent,
          pathMatch: 'full'
        }
        ,
        {
          path: 'endPoints',
          component: import16.EndPointListComponent
        }
        ,
        {
          path: 'endPoints/:id',
          component: import17.EndPointDetailComponent
        }
  ...
  get _Router_10():any {
    if ((this.__Router_10 == null)) { (this.__Router_10 = import2.setupRouter(this.parent.get(import18.ApplicationRef),this._UrlSerializer_6,this._RouterOutletMap_7,this._Location_5,this,this._NgModuleFactoryLoader_8,this.parent.get(import14.Compiler),this._ROUTES_9,this._ROUTER_CONFIGURATION_3,this.parent.get(import19.UrlHandlingStrategy,(null as any)),this.parent.get(import20.RouteReuseStrategy,(null as any)))); }
  ...
  get _ROUTER_INITIALIZER_17():any {
    if ((this.__ROUTER_INITIALIZER_17 == null)) { (this.__ROUTER_INITIALIZER_17 = import2.initialRouterNavigation(this._Router_10,this.parent.get(import18.ApplicationRef),this._RouterPreloader_14,this._ROUTER_CONFIGURATION_3)); }
  ...
  createInternal():import1.AppRoutingModule {
    this._ROUTER_FORROOT_GUARD_0 = import2.provideForRootGuard(this.parent.get(import21.Router,(null as any)));
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import13.LocationStrategy)) { return this._LocationStrategy_4; }
    ...
    if ((token === import22.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_8; }
    if ((token === import23.ROUTES)) { return this._ROUTES_9; }
    if ((token === import21.Router)) { return this._Router_10; }
    if ((token === import24.ActivatedRoute)) { return this._ActivatedRoute_11; }
    ...
    if ((token === import18.NgProbeToken)) { return this._NgProbeToken_16; }
    if ((token === import2.ROUTER_INITIALIZER)) { return this._ROUTER_INITIALIZER_17; }
    if ((token === import25.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_18; }
